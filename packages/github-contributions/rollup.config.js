...
export default (async () => [
  {
    input: 'src/index.js',
    output: {
      file: `dist/github-contributions.umd${prefix}.js`,
      format: 'umd',
  ...
  },
  {
    ...
    output: [
      { file: `dist/github-contributions.cjs${prefix}.js`, format: 'cjs', banner },
      { file: `dist/github-contributions.esm${prefix}.js`, format: 'es', banner },
    ],
